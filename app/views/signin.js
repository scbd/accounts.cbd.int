...
export { default as template } from './signin.html';
export default ['$scope', '$http', '$cookies', 'authentication', 'user', 'apiToken', function ($scope, $http, $cookies, authentication, user, apiToken) {
